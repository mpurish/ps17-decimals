...
class ProductControllerCore extends ProductPresentingFrontControllerCore
{
    ...
    protected function getMinimalProductOrDeclinationQuantity($product)
    {
        ...
        if ($this->combinations) {
            $minimalCombinationProductQuantity = (float) ($this->combinations[$productAttributeId]['minimal_quantity']);
    ...
    protected function assignAttributesGroups($product_for_template = null)
    {
        ...
        if (is_array($attributes_groups) && $attributes_groups) {
            ...
            foreach ($attributes_groups as $k => $row) {
                ...
                $groups[$row['id_attribute_group']]['attributes_quantity'][$row['id_attribute']] += (float) $row['quantity'];
                ...
                $this->combinations[$row['id_product_attribute']]['quantity'] = (float) $row['quantity'];
    ...
    {
        $requiredQuantity = (float) Tools::getValue('quantity_wanted', $this->getProductMinimalQuantity($product));
