...
//                        $qtyList = array_map('intval', $qtyList);
                        $qtyList = array_map('float', $qtyList);/**************8888888888*********/
                    }
    ...
    protected function doEditProductValidation(OrderDetail $order_detail, Order $order, OrderInvoice $order_invoice = null)
    {
        ...
        if (!is_array(Tools::getValue('product_quantity')) && !Validate::isFloat(Tools::getValue('product_quantity'))) {/******8888888888888************/
            die(json_encode(array(
                'result' => false,
